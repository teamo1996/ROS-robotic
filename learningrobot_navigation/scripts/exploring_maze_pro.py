...
######################################请补充更多位置（开始）######################################################
        ...
        locations.append(Pose(Point(3.529, 7.763, 0.000),  Quaternion(0.000, 0.000, -0.163554119075, 0.705191515089)))  
        locations.append(Pose(Point(2.729, 1.168, 0.000),  Quaternion(0.000, 0.000, -0.709519194356, 0.704686109442)))  
        locations.append(Pose(Point(7.525, 1.936, 0.000),  Quaternion(0.000, 0.000, -0.636628380104, 0.771170737026)))  
...
######################################请补充主循环中的代码（开始）######################################################
            ...
            if not finished_within_time:
                self.move_base.cancel_goal(self.goal)
